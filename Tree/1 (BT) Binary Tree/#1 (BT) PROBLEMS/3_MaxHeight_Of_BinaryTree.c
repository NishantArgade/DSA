...
int IT_MaxHeightOfTree(struct BTreeNode *root)
{
    struct Queue q;
    CreateQueue(&q, 100);
...
int main()
{
    ...
    printf("\nRecursive : Max Height of Tree is : %d ",RE_MaxHeightOfTree(root) );
    printf("\nIterative : Max Height of Tree is : %d ", IT_MaxHeightOfTree(root));
