...
// Recursive level order Function for Traversing:
...
void DisplayReverseOfBtree(struct BTNode* root){
  struct Queue q;
  CreateQueue(&q,100);
...
int main()
{
    ...
    printf("\nLevel-Order Traversal After DispalyReverse function is :");
    DisplayReverseOfBtree(root) ;
