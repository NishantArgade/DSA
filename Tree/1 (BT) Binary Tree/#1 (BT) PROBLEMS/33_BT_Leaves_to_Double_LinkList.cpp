...
struct BTNode * BTtoDLL(struct BTNode *root, struct BTNode *&head, struct BTNode *&tail)
{
    ...
    // If Curr node is Leaf node then and then process this if block :
...
{
    printf("The Double LinkList  Structure of Leafs of BT is :\n");
